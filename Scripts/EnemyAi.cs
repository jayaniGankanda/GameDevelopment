...
public class EnemyAi : MonoBehaviour
{
    ...
    public bool isWalkingLeft = true;   //if there is multiple enemies, this should be fales
    ...
    void UpdateEnemyPosition()
    {
        if(state != EnemyState.dead)
        {
            ...
            CheckWalls(pos, scale.x);   //Run check walls code   
    ...
    Vector3 CheckGround (Vector3 pos)
    {
        ...
        RaycastHit2D groundRight = Physics2D.Raycast(originLeft, Vector2.down, velocity.y * Time.deltaTime, floorMask);

        if (groundLeft.collider != null || groundMiddle.collider != null || groundMiddle.collider != null)
        {
            ...
            //Game over when enemy hit the player 
    ...
    //Enemy detect wall and come back after hitting 
    ...
    //Object get active from deactive when ever object is visibled 
